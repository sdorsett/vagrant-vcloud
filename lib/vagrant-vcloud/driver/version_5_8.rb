    ...
    module Driver
      ...
      class Version_5_8 < Base
        ...
        def initialize(hostname, username, password, org_name)
          @logger = Log4r::Logger.new('vagrant::provider::vcloud::driver_5_8')
          uri = URI(hostname)
        ...
        def get_organizations
          ...
          results = {}
          orgs.each do |org|
            results[org['name']] = URI(org['href']).path.gsub('/api/compute/api/org/', '')
          end
          results
        end
        ...
        def get_organization(org_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/org/#{org_id}"
          }
        ...
        def get_catalog(catalog_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/catalog/#{catalog_id}"
          }
        ...
        def get_catalog_id_by_name(organization, catalog_name)
          ...
          if result.nil?
            ...
            params = {
              'method'  => :get,
              'command' => '/compute/api/catalogs/query/',
              'cacheable' => true
            }
        ...
        def get_vdc(vdc_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/vdc/#{vdc_id}"
          }
        ...
        def get_catalog_item(catalog_item_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/catalogItem/#{catalog_item_id}"
          }
          ...
          response.css(
            ...
            items[item['name']] = URI(item['href']).path.gsub(
              '/api/compute/api/vAppTemplate/vappTemplate-', ''
            )
          end
          { :description => description, :items => items }
        end
        ...
        def get_catalog_item_by_name(catalog_id, catalog_item_name)
          ...
          catalog_elems[:items].each do |catalog_elem|
            ...
            if catalog_item[:items][catalog_item_name]
              ...
              params = {
                'method'  => :get,
                'command' => "/compute/api/vAppTemplate/vappTemplate-#{catalog_item_id}"
              }
              response, _headers = send_request(params)
              ...
              response.css('/VAppTemplate/Children/Vm').each do |vm_elem|
                ...
                vm_id = URI(vm_elem['href']).path.gsub(
                  '/api/compute/api/vAppTemplate/vm-', ''
                )
        ...
        def get_vapp(vapp_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}"
          }
          ...
          vms.each do |vm|
            ...
            vms_hash[vm['name'].to_sym] = {
              ...
              :id                   => URI(vm['href']).path.gsub('/api/compute/api/vApp/vm-', ''),
        ...
        def delete_vapp(vapp_id)
          ...
          _response, headers = send_request(params)
          task_id = URI(headers['Location']).path.gsub('/api/compute/api/task/', '')
          task_id
        end
        ...
        def poweroff_vapp(vapp_id)
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/action/undeploy"
          }
        ...
        def suspend_vapp(vapp_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/power/action/suspend"
          }
        ...
        def reboot_vapp(vapp_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/power/action/reboot"
          }
        ...
        def reset_vapp(vapp_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/power/action/reset"
          }
        ...
        def poweron_vapp(vapp_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/power/action/powerOn"
          }
        ...
        def delete_vm(vm_id)
          params = {
            'method'  => :delete,
            'command' => "/compute/api/vApp/vm-#{vm_id}"
          }
        ...
        def poweroff_vm(vm_id)
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vm-#{vm_id}/action/undeploy"
          }
        ...
        def reboot_vm(vm_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vm-#{vm_id}/power/action/reboot"
          }
        ...
        def reset_vm(vm_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vm-#{vm_id}/power/action/reset"
          }
        ...
        def poweron_vm(vm_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vm-#{vm_id}/power/action/powerOn"
          }
        ...
        def create_catalog(org_id, catalog_name, catalog_description)
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/admin/org/#{org_id}/catalogs"
          }
        ...
        def create_vapp_from_template(vdc, vapp_name, vapp_description, vapp_template_id, poweron = false)
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vdc/#{vdc}/action/instantiateVAppTemplate"
          }
          ...
          vapp_id = URI(headers['Location']).path.gsub('/api/compute/api/vApp/vapp-', '')

          task = response.css(
            "VApp Task[operationName='vdcInstantiateVapp']"
          ).first

          task_id = URI(task['href']).path.gsub('/api/compute/api/task/', '')
        ...
        def compose_vapp_from_vm(vdc, vapp_name, vapp_description, vm_list = {}, network_config = {})
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vdc/#{vdc}/action/composeVApp"
          }
        ...
        def recompose_vapp_from_vm(vapp_id, vm_list = {}, network_config = {})
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/action/recomposeVApp"
          }
        ...
        def get_vapp_template(vapp_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/vAppTemplate/vappTemplate-#{vapp_id}"
          }
          ...
          vms.each do |vm|
            vms_hash[vm['name']] = {
              :id => URI(vm['href']).path.gsub('/api/compute/api/vAppTemplate/vm-', '')
            }
          end
        ...
        def set_vapp_port_forwarding_rules(vapp_id, network_name, config = {})
          ...
          params = {
            'method'  => :put,
            'command' => "/compute/api/vApp/vapp-#{vapp_id}/networkConfigSection"
          }
        ...
        def find_edge_gateway_id(edge_gateway_name, vdc_id)
          params = {
            'method'  => :get,
            'command' => '/compute/api/query?type=edgeGateway&' \
                         'format=records&' \
        ...
        def redeploy_edge_gateway(edge_gateway_id)
          params = {
            'method'  => :post,
            'command' => "/compute/api/admin/edgeGateway/#{edge_gateway_id}/action/redeploy"
          }
        ...
        def find_edge_gateway_network(edge_gateway_name, vdc_id, edge_gateway_ip)
          ...
          params = {
            'method'  => :get,
            'command' => "/compute/api/admin/edgeGateway/#{edge_gateway_id}"
          }
        ...
        def remove_edge_gateway_rules(edge_gateway_name, vdc_id, edge_gateway_ip, vapp_id)
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/admin/edgeGateway/#{edge_gateway_id}/action/" +
                         'configureServices'
          }
        ...
        def upload_ovf(vdc_id, vapp_name, vapp_description, ovf_file, catalog_id, upload_options = {})
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vdc/#{vdc_id}/action/uploadVAppTemplate"
          }
          ...
          begin
            params = {
              'method'  => :get,
              'command' => "/compute/api/vAppTemplate/vappTemplate-#{vapp_template}"
            }
            ...
            params = {
              'method'  => :post,
              'command' => "/compute/api/catalog/#{catalog_id}/catalogItems"
            }
            ...
            ).first[:href]).path.gsub('/api/compute/api', '')
        ...
        def get_task(task_id)
          params = {
            'method'  => :get,
            'command' => "/compute/api/task/#{task_id}"
          }
        ...
        def set_vm_network_config(vm_id, network_name, config = {})
          ...
          params = {
            'method'  => :put,
            'command' => "/compute/api/vApp/vm-#{vm_id}/networkConnectionSection"
          }
        ...
        def set_vm_guest_customization(vm_id, computer_name, config = {})
          ...
          params = {
            'method'  => :put,
            'command' => "/compute/api/vApp/vm-#{vm_id}/guestCustomizationSection"
          }
        ...
        def set_vm_nested_hypervisor(vm_id, enable)
          ...
          params = {
            'method'  => :post,
            'command' => "/compute/api/vApp/vm-#{vm_id}/action/#{action}NestedHypervisor"
          }
        ...
        def set_vm_hardware(vm_id, cfg)
          params = {
            'method'  => :get,
            'command' => "/compute/api/vApp/vm-#{vm_id}/virtualHardwareSection"
          }
...
i            task_id = URI(headers['Location']).path.gsub('/api/compute/api/task/', '')
            task_id
          else
            return nil
          end
